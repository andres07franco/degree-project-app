...
public class ListaMarcas extends javax.swing.JPanel implements Buscadores {
    ...
    public ListaMarcas(JTabbedPane pestana, Frame padre) {
    ...
    public Marca setObjeto(String criterio, String valor) {
        Marca grupo = new Marca();

        if (criterio.equals("Marca")) {
            grupo.setMarca("%" + valor + "%");
