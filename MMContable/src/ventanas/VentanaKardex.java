...
public class VentanaKardex extends javax.swing.JDialog {
    ...
    public VentanaKardex(java.awt.Frame parent, boolean modal, Model m) {
        super(parent, modal);
        this.parent = parent;
        this.m = m;
        initComponents();
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(fecha, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 121, Short.MAX_VALUE)
    ...
    private void imprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imprimirActionPerformed
            ...
            if (a != null) {
                if (!fecha.getText().equals("")) {
                    if (!fecha1.getText().equals("")) {
                        ...
                        parametro.put("id_a", "" + a.getId());
                        parametro.put("codigo", "" + a.getCodigobarras());
                        parametro.put("grupo", "" + a.getGrupo().getGrupo());
                        parametro.put("marca", "" + a.getMarca().getMarca());
                        if (a.getTipo() == 1) {
                            parametro.put("tipo", "Servicio");
                        } else if (a.getTipo() == 0) {
                            parametro.put("tipo", "Articulo");
                        } else if (a.getTipo() == 3) {
                            parametro.put("tipo", "Combo/Kit");
                        }
                        parametro.put("existencia", "" + a.getExistencia());
                        parametro.put("min", "" + a.getCantidadminima());

                        this.dispose();
                        new managers.Reporte(m.conexionPorDefecto(), this).runReporte("Reportes/kardex.jasper", parametro);
                    } else {
        ...
        private void buscaraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscaraActionPerformed
            ...
            a = new BuscaArticulo(parent, true, m).getArticulo();
            if (a != null) {
