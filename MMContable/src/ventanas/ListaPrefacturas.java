...
public class ListaPrefacturas extends javax.swing.JPanel implements Buscadores {
    ...
    public ListaPrefacturas(JTabbedPane tab, JDesktopPane dp, Model m, Frame parent) {
        this.tab = tab;
        this.dp = dp;
        this.m = m;
        this.parent = parent;
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        ...
        if (tabla.getSelectedRow() > -1) {
            new Formulario_Prefactura(parent, true, this, l.get(tabla.getSelectedRow()), m);
        } else {
    ...
    private void nuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nuevoActionPerformed
        // TODO add your handling code here:
        Formulario_Prefactura fp = new Formulario_Prefactura(parent, true, this, m);
    ...
    public void buscar() {
        ...
        l = md.listarPrefacturas(por.getSelectedIndex(), busqueda.getText());
