...
public class Model {
    ...
    private Model() {
        try {
            ...
            javax.swing.JOptionPane.showMessageDialog(null,"Debe iniciar el servidor MYSQL para poder empezar" + ex.getMessage(),"Inconveniente",javax.swing.JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
            System.exit(0);
        }
    }
